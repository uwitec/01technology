package 
{
		...
		import org.god.SkinControl.*;
		
		//界面样式
		public class GOMLAF extends BasicLookAndFeel
		{
			//构造函数
			public function GOMLAF()
			{
				super();
			}
			...
			override protected function initComponentDefaults(table:UIDefaults):void
			{
				...
				// *** Button
				 comDefaults = [
					"SkinButton.background", buttonBG,
					"SkinButton.foreground", table.get("controlText"),
					"SkinButton.opaque", true,  
					"SkinButton.focusable", true,  
					"SkinButton.shadow", table.getColor("controlShadow"),		
					"SkinButton.darkShadow", table.getColor("controlDkShadow"),		
					"SkinButton.light", table.getColor("controlHighlight"),	   
	   				"SkinButton.highlight", table.getColor("controlLtHighlight"),
					"SkinButton.font", table.getFont("controlFont"),
					"SkinButton.bg", org.aswing.plaf.basic.background.ButtonBackground,
					"SkinButton.margin", new InsetsUIResource(2, 3, 3, 2), 
					"SkinButton.textShiftOffset", 1
				];
				table.putDefaults(comDefaults);
				comDefaults = [
					"SkinButton.opaque", false, 
					"SkinButton.defaultImage", Button_defaultImage,
					"SkinButton.pressedImage", Button_pressedImage,
					"SkinButton.disabledImage", Button_disabledImage,
					"SkinButton.rolloverImage", Button_rolloverImage, 
					"SkinButton.DefaultButton.defaultImage", Button_DefaultButton_defaultImage, 
					"SkinButton.bg", SkinButtonBackground,
					"SkinButton.margin", new InsetsUIResource(3, 3, 3, 2), //modify this to fit the image border margin 
					"SkinButton.textShiftOffset", 0
				];
				table.putDefaults(comDefaults);
				 comDefaults = [
					"System.hHandCursor", new HandCurosr
					];
				 table.putDefaults(comDefaults);
				/*
				// *** ToggleButton
				...
				*/
				...
				comDefaults = [
					...
					"TabbedPane.contentMargin", new InsetsUIResource(0, 0, 0, 0), //modify this to fit TabbedPane_contentRoundImage
					...
					"TabbedPane.contentRoundLineThickness", 2, //modify this to fit contentRoundImage
