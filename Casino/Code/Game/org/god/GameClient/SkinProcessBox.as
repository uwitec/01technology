package
{
	...
	{
		private static const nMaxProcessCell:int = 12;//进度单元数目
		private static var _mySelf:SkinProcessBox = null;//全局状态对话框

		private var m_arrProcessCellA:Array;//进度单元A数组
		private var m_arrProcessCellN:Array;//进度单元B数组
		private var m_nCurCellIndex = -1;//进度单元当前索引
		...
		public function SkinProcessBox(strMsg:String)
		{
			...
			m_labelMessage.setForeground(new ASColor(0xf1e8a5));
