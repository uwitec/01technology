...
//游戏状态
const GS_WK_FREE:uint=GS_FREE;//等待开始
const GS_WK_SCORE:uint=GS_PLAYING;//叫分状态
const GS_WK_PLAYING:uint=GS_PLAYING+1;//游戏进行
const GS_WK_DOUBLETIME:uint=GS_PLAYING+2;//反地主状态
...
const SUB_S_DOUBLETIME=106;//反地主
const SUB_S_USERDOUBLETIME=107;//用户反地主
