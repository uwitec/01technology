package 
{
	...
	//修改子用户基本信息对话框
	public class BasicSubUserInfoDlg extends BaseDialog
	{
		protected var m_pParentUserData:tagUserData;
		protected var m_pSetBaiscInfoSubUserData:tagSubUserData;
		...
		public function BasicSubUserInfoDlg(pParentUserData:tagUserData,
											pSetBaiscInfoSubUserData:tagSubUserData,
										   pUserData:*,owner:* = null)
		{
			super(new IMAGE_DLG_BASICUSERINFO(449,285), pUserData, owner);
			
			m_pParentUserData = pParentUserData;
			m_pSetBaiscInfoSubUserData = pSetBaiscInfoSubUserData;
		...
		public override function Destroy():void
		{
			...
			m_pSetBaiscInfoSubUserData = null;
		...
		protected function InitControl():void
		{
			...
			m_tfAccount.setText(m_pSetBaiscInfoSubUserData.szAccount);
			m_tfName.setText(m_pSetBaiscInfoSubUserData.szName);
		...
		override public function OnEventOK(e:Event):void
		{
			...
			var BasicSubUserInfo:CMD_GP_BasicSubUserInfo = m_pUserData  as CMD_GP_BasicSubUserInfo;
			BasicSubUserInfo.dwUserID = m_pSetBaiscInfoSubUserData.dwUserID;
			BasicSubUserInfo.szName = m_tfName.getText();
			BasicSubUserInfo.szPassWord = MD5.hash(m_tfPasswd.getText());
			
			dispatchEvent(new DialogEvent(DialogEvent.CMD_OK, m_pUserData, m_pParentUserData,m_pSetBaiscInfoSubUserData));
