...
public class JTable extends Container implements Viewportable, TableModelListener, TableColumnModelListener, CellEditorListener, LayoutManager{
	...
	//viewport
	//god
	protected var viewPosition:IntPoint;
	...
	//god
	public function getTableCell(r:int,c:int):TableCell
	{
		return rowCells[r][c];
	}
...
//		editorRemover = null;
	 ...
	 *
	 */	
	 protected function doLayoutSuper():void
	 {
		 super.doLayout();
	 }
	...
	protected function getLastTotalColumnWidth():int{
	...
	protected var lastTotalColumnWidth:int=-1;
