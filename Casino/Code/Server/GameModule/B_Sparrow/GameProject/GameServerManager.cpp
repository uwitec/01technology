...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("麻将模板GameService组件"),CountArray(m_GameServiceAttrib.szDescription));
	m_GameServiceAttrib.wProcessType = ID_B_SPARROW;
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("B_Sparrow.dll"),CountArray(m_GameServiceAttrib.szServerModuleName));
