...
protected:
	...
	WORD							m_wBeginTurnUser;						//当前用户
	BYTE							m_bSendCardCount;						//发牌数目
	BYTE							m_bTableCardCount[GAME_PLAYER];			//扑克数目
	BYTE							m_bTableCardArray[GAME_PLAYER][3];		//桌面扑克 
	WORD                            m_wCurrentWiner;                        //赢家椅子号

	//金币信息
protected:
	DOUBLE							m_fMaxGold;								//最大下注
	DOUBLE							m_fTurnMaxGold;							//最大下注
...
protected:
	...
	BYTE                            m_bKanPaiFlag[GAME_PLAYER+1];           //看牌状态   
