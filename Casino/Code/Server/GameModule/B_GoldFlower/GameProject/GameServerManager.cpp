...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("诈金花GameService组件"),CountArray(m_GameServiceAttrib.szDescription));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("B_GoldFlower.dll"),CountArray(m_GameServiceAttrib.szServerModuleName));
	m_GameServiceAttrib.wProcessType = ID_B_THREELEAF;
