...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("斗地主GameService组件"),CountArray(m_GameServiceAttrib.szDescription));
	m_GameServiceAttrib.wProcessType = ID_B_LAND;
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("B_Land.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
