	...
	public class CardControl extends Sprite
	{
		...
		public function OnPaint(pDC:BitmapData,rcClient:Rectangle):void
		{
			...
			for (var i:uint=0;i<m_CardDataItem.length;i++)
			{
				...
				{
					dwXImagePos=Number((pCardItem.bCardData&CARD_MASK_VALUE)-1)*m_CardSize.x;
					dwYImagePos=Number((pCardItem.bCardData&CARD_MASK_COLOR)>>4)*m_CardSize.y;
...
include "../../../../GameModule/B_Hoe/Common/GameLogicDef.as"
include "../../../Memory.as"