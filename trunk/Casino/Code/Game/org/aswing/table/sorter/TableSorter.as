...
public class TableSorter extends AbstractTableModel implements TableModelListener{
    ...
    protected var viewToModel:Array; //Row[]
    protected var modelToView:Array; //int[]
    protected var columnSortables:Array;

    protected var tableHeader:JTableHeader;
    protected var tableModelListener:TableModelListener;
    protected var columnComparators:HashMap;
    protected var sortingColumns:Array;
	...
	//god
    protected function getViewToModel():Array {
        if (viewToModel == null) {
    ...
    protected function sortImp(row1:Row, row2:Row):int{
