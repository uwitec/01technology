 ...
 * @private
 */
public class SkinButtonUI extends BaseComponentUI
{
	...
	//god
	private var handCursor:DisplayObject;
	
	public function SkinButtonUI(){
		super();
		handCursor = Cursor.createCursor("System.hHandCursor");
	}
	...
	override public function uninstallUI(c:Component):void{
 	...
 	protected function installListeners(b:AbstractButton):void{
 		b.addEventListener(MouseEvent.ROLL_OVER, __onButtonRollover);
		b.addEventListener(MouseEvent.ROLL_OUT, __onButtonRollout);
 	...
 	protected function uninstallListeners(b:AbstractButton):void{
	 	b.removeEventListener(MouseEvent.ROLL_OVER, __onButtonRollover);
		b.removeEventListener(MouseEvent.ROLL_OUT, __onButtonRollout);
    ...
    //--------------------------------------------------------
    private function __onButtonRollover(e:MouseEvent):void
    {
   	 	if(handCursor)
    		CursorManager.showCustomCursor(handCursor);
    }
    private function __onButtonRollout(e:MouseEvent):void
    {
    	if(handCursor)
    		CursorManager.hideCustomCursor(handCursor);
    }
