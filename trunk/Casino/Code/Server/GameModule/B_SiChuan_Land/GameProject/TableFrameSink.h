...
protected:
	...
	BYTE							m_bDoubleTimeScore[3];				//反牌信息
...
public:
	...
	//请求断线
	virtual bool __cdecl OnEventUserReqOffLine(WORD wChairID, IServerUserItem * pIServerUserItem, WORD wOffLineCount) { return true; }
	//请求重入
...
public:
	...
	//用户起来
	virtual bool __cdecl OnEventUserStandUp(WORD wChairID, IServerUserItem * pIServerUserItem, bool bLookonUser) { return true; }
...
protected:
	...
	//用户反牌
	bool OnDoubleTime(WORD wChairID, BYTE bDoubleTime);
...
protected:
	//寻找地主
	WORD FindLandUserBySpecialCard(BYTE bHandCardData [3][20], BYTE bCardCount [3], WORD wBeginChair);
	//游戏开始
	bool GameStart();
};
