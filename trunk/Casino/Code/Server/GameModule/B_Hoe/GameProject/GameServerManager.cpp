...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("锄大地GameService组件"),CountArray(m_GameServiceAttrib.szDescription));
	m_GameServiceAttrib.wProcessType = ID_B_HOE;
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("B_Hoe.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
