...
public:
	...
	virtual bool __cdecl InsertGameServer(tagGameServer * pGameServer,
		WORD wIndex = 0xFFFF,WORD wRoundID = 0xFFFF);
	//插入站点
...
public:
	...
	//加载全部列表
	virtual bool __cdecl LoadAllServerList(tagDataBaseInfo & DataBaseInfo);
	//更新人数
...
private:
	...
	//加载服務
	void LoadGameServer(IDataBase * pIDataBase);
