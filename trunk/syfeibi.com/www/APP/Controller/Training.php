...
/**
 * Controller_Training 类是 Smarty 示例的默认控制器
 *
 * @package Example
 * @subpackage Smarty
 * @author 起源科技 (www.qeeyuan.com)
 * @version 1.0
 */
class Controller_Training extends FLEA_Controller_Action
{
	var $_metas;
    /**
     * 构造函数
...
/*    function actionList() {
    ...
    function actionIndex() {
        ...
        $smarty->display('tpl-training.dwt');
    }
