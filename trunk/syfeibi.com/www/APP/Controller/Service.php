...
/**
 * Controller_Service 类是 Smarty 示例的默认控制器
 *
 * @package Example
 * @subpackage Smarty
 * @author 起源科技 (www.qeeyuan.com)
 * @version 1.0
 */
class Controller_Service extends FLEA_Controller_Action
{
    var $_modelService;
	var $_metas;
    /**
...
/*    function actionList() {
    ...
    function actionIndex() {
        ...
        $smarty->display('tpl-service.dwt');
    }
