<?php /* Smarty version 2.6.18, created on 2009-08-09 21:26:19
         compiled from tpl-albums-hs.dwt */ ?>
...
unset($_smarty_tpl_vars);
 ?>
  <div class="bg">
  <div class="path_url">当前位置:<a href="/">首页</a> &gt; 婚纱相册</div>  
...
" /></a>
  ...
  <div class="show_album_list">
   ...
   <ul class="show_album_menu">
    <li id="show_all"><a href="/index.php/Albums"><img src="<?php echo IMG_DIR ?>/album_button_all_no.png" alt="全部作品展示"/></a></li>
    <li id="show_hz"><a href="/index.php/Albums/Hz"><img src="<?php echo IMG_DIR ?>/album_button_hz_no.png" alt="化妆作品展示" /></a></li>
    <li id="show_hs"><img src="<?php echo IMG_DIR ?>/album_button_hs_sel.png" alt="婚纱礼服展示" /></li>
   </ul>
